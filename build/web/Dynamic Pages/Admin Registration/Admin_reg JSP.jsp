...
<html>
    ...
    <body>
        ...
        PreparedStatement ps = con.prepareStatement("insert into ADMIN_DETAILS (GENDER,FIRST_NAME,LAST_NAME,ADDRESS,CITY,STATE,PHONE_NO,DOB,EMAIL_ID,PASSWORD) values(?,?,?,?,?,?,?,?,?,?)");
        ...
        ps.setString(8,P_Dob);
        ps.setString(9,P_Email);
        ps.setString(10,P_Pwrd);
        ...
        if(rs>0)
        {
            ...
            %>
                        <jsp:forward page="Admin_reg_forward.jsp"/>
                    <%
        }
        }
        catch(Exception ex)
